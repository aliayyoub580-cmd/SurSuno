...
export function Signup() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      // On signup, redirect straight into onboarding artists picker
  ...
  return (
    <div className="min-h-screen w-full bg-[#060608] text-white flex flex-col items-center justify-center p-3 sm:p-6 relative overflow-y-auto select-none">
      ...
      <div className="absolute bottom-10 left-10 w-[300px] h-[300px] bg-accent/15 rounded-full blur-[100px] pointer-events-none" />
      ...
      >
        ...
        <div className="text-center space-y-1.5 pt-1">
          ...
          <h1 className="text-xl sm:text-2xl font-black tracking-tight text-white">Create your account</h1>
          <p className="text-xs text-white/60">Join SurSuno to discover & stream unlimited music</p>
        </div>
